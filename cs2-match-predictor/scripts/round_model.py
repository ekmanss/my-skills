...
def main():
    parser = argparse.ArgumentParser(description="CS2 MR12 live map win and total-round probability calculator.")
    ...
    parser.add_argument("--p-round-a", type=float, required=True, help="Estimated Team A probability for each remaining regulation round")
    parser.add_argument("--ot-win-a", type=float, default=0.5, help="Estimated Team A overtime win probability")
